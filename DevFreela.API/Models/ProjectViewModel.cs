...
namespace DevFreela.API.Models
{
    ...
    {
        public ProjectViewModel(int id, string title, string description, int idClient, 
            int idFreelancer, string clientName, string freelancerName, 
        ...
        //Cria um método statico que retorna a sua viewmodel
